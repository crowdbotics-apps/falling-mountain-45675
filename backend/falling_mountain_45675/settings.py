"""
Django settings for falling_mountain_45675 project.
...
ROOT_URLCONF = 'falling_mountain_45675.urls'
...
WSGI_APPLICATION = 'falling_mountain_45675.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_mountain_45675 API",
    "DESCRIPTION": "API documentation for falling_mountain_45675 App",
    "VERSION": "v1",
}
